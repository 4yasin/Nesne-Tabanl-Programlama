...
# Bu proje, eğitim materyallerini paylaşmak ve öğrencilere kolay erişim sağlamak amacıyla bir platform oluşturmayı amaçlamaktadır. 
# Öğretmenler ders materyallerini yükleyebilir ve öğrenciler bu materyalleri inceleyebilir, sorular sorabilir ve dersler hakkında tartışmalara katılabilir.
