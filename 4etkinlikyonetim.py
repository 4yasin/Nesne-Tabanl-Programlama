...
# Bu proje, etkinliklerin, katılımcıların ve biletlerin yönetimini sağlamak amacıyla geliştirilmiştir.
# Katılımcılar etkinliklere kayıt olabilir ve bilet işlemlerini gerçekleştirebilir.
