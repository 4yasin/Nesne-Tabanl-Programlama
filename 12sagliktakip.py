...
# Bu proje, kullanıcıların kişisel sağlık verilerini kaydedebileceği, egzersiz rutinlerini planlayabileceği
# ve sağlık durumlarını izleyebileceği bir uygulama geliştirmeyi amaçlamaktadır.
# Kullanıcılar, sağlık verilerini düzenli olarak kaydedebilir, egzersiz rutinleri oluşturabilir ve 
# sağlık hedeflerine yönelik ilerlemelerini takip edebilirler.
...
class Arayuz(QWidget):
    ...
    def saglik_arayuz_olustur (self):
        ...
        self.boy_input.setMaxLength (3)  
        self.kilo_input = QLineEdit ()
        self.kilo_input.setMaxLength (3)  

       
        boy_validator = QIntValidator (0, 300) 
        kilo_validator = QIntValidator (0, 300)  
