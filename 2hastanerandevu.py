...
# Bu proje, hastaların doktorlardan randevu alabileceği bir sistem geliştirmeyi amaçlamaktadır.
# Hastalar randevu oluşturabilir veya mevcut randevularını iptal edebilir.
