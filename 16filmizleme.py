...
# Bu proje, kullanıcıların filmleri ve dizileri çevrimiçi izlemelerini sağlayan bir platform geliştirmeyi amaçlamaktadır. 
# Kullanıcılar, içerikleri izleme listelerine ekleyebilir, izledikleri içerikleri kaydedebilir ve önerilen içeriklere göz atabilir.
