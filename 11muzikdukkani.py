...
# Bu proje, müzik enstrümanları satan bir dükkanın yönetimini kolaylaştıracak bir sistemdir.
# Müzik enstrümanları dükkanının temel işlevleri arasında stok takibi, müşteri siparişlerinin yönetimi,
# satış işlemlerinin kaydedilmesi ve satış sonrası destek taleplerinin düzenlenmesi yer almaktadır.
# Sistem, müşterilerin enstrümanları görüntülemesini, siparişlerini oluşturmasını ve destek taleplerini iletmelerini sağlar.
# Dükkan yöneticileri ise enstrümanları sisteme ekleyebilir, stok durumlarını takip edebilir, satışları kaydedebilir
# ve müşteri taleplerine hızlıca yanıt verebilirler.
