...
# Bu proje, restoranların sipariş alımı, menü yönetimi ve teslimat süreçlerini yönetmelerine yardımcı olacak bir sistemdir.
# Restoranlar, menülerini kolayca yönetebilir, sipariş alabilir ve teslimat sürecini takip edebilirler.
# Sistem, hem restoran personelinin hem de müşterilerin etkileşimini kolaylaştırmak için tasarlanmıştır.
...
class RestaurantApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("KÜLTÜRÜNİVERSİTESİ.COM")
        ...
        self.welcome_label = QLabel("KÜLTÜRÜNİVERSİTESİ.COM'a HOŞGELDİNİZ!!!")
        self.welcome_label.setAlignment(Qt.AlignCenter)
        self.layout.addWidget(self.welcome_label)
        
        self.welcome_label = QLabel("MAYIS AYINA ÖZEL TEKLİFLER!")
        self.welcome_label.setAlignment(Qt.AlignCenter)
        self.layout.addWidget(self.welcome_label)
