...
# Bu proje, kullanıcıların kitapları çevrimiçi olarak okumasını, kitaplar hakkında yorum yapabilmesini ve okuma listelerini oluşturabilmesini
# sağlayan bir platform oluşturmayı hedefliyor. Kullanıcılar, kitap ekleyebilir, okuyabilir, beğenilerini ve görüşlerini diğer kullanıcılarla
# paylaşabilir.
