...
# Bu proje, kullanıcıların yemek tariflerini ekleyip arayabileceği ve tarifleri değerlendirebileceği bir platformdur.
# Sistem Tarif, Malzeme ve Kullanıcı sınıflarından oluşmaktadır.
