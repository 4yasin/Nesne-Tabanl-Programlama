# Tarihi Olaylar Veritabanı
# Bu proje, tarihi olaylar, şahsiyetler ve dönemler hakkında bilgi kaydedilmesini, sorgulanmasını ve ilişkilendirilmesini sağlayacak bir veritabanı
# sistemidir. Kullanıcılar, tarihsel olayları arayabilir, belirli şahsiyetlerle ilişkilendirilmiş olayları inceleyebilir ve geçmişteki tarihi dönemleri
# sorgulayabilirler. Bu platform, tarihçiler, araştırmacılar ve tarih meraklıları için değerli bir kaynak olacak şekilde tasarlanmıştır.
...
class TarihOlaylariUygulamasi(QMainWindow):
    ...
    def show_story(self):
        ...
        self.show_extra_info(selected_event)  
